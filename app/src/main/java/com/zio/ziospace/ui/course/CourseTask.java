...
import static com.zio.ziospace.helpers.Constants.FILE_PICK;
...
public class CourseTask extends AppCompatActivity {
    ...
    private void load_details() {
        ...
        submit_ref.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(CourseTask.this, "Something went wrong try later", Toast.LENGTH_SHORT).show();
            }
        });
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    task_storage.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            Toast.makeText(CourseTask.this, "Something has gone wrong", Toast.LENGTH_LONG).show();
                        }
                    });
                }
            }).addOnFailureListener(new OnFailureListener() {
        ...
        tasks_ref.child("fileuri").setValue(uri.toString())
                .addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        Toast.makeText(CourseTask.this, " File submitted successfully ", Toast.LENGTH_LONG).show();
                    }
                }).addOnFailureListener(new OnFailureListener() {
                    @Override
                    public void onFailure(@NonNull Exception e) {
